    ...
    return (
        <div>
            ...
            <div className="guideline bg-teal-100 ">
                ...
                <div className="step">
                    <h1>Bước 4</h1>
                    <p>1 ly coffee sẽ giúp bạn luôn tỉnh táo xuyên suốt quá trình trò chuyện cùng Pilyr. 
            ...
            <div className="guideline bg-teal-100">
                ...
                <div className="step">
                    <h1>Bước 6</h1>
                    <p>
                        Mỗi ly coffee sẽ giúp bạn có thể trò chuyện cùng Pilyr trong vòng 20 phút. Chọn "Đồng ý" để xác nhận sử dụng 1 ly coffee. 
